        ...
        <section id="accueil" className="relative bg-[#0A0A0B]">
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full opacity-40">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-brand-accent/5 via-transparent to-transparent" />
                </div>
                <motion.div
            ...
            <div className="container max-w-7xl mx-auto px-6 flex flex-col items-center relative z-10 pt-36">
                ...
                <span className="text-4xl md:text-6xl font-bold mb-6 text-[#F9FAFB]">
                  Bientôt Disponible
                                ...
                                >
                  <span className="bg-gradient-to-r from-brand-accent via-brand-hover to-brand-accent bg-clip-text text-transparent animate-gradient-x">
                    La Nouvelle Ère du Sport
                  </span>
                                    <span className="absolute -inset-2 bg-brand-accent/10 blur-2xl rounded-lg opacity-75 group-hover:opacity-100 transition duration-1000" />
                                </motion.span>
                            </h1>
                        </motion.div>
